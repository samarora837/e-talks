...
<title><spring:message code="home.news" /></title>
    ...
    <div class="inner-row">
      <div class="form-tutor-con">
        <div class="bcm-tutor-con news-con">
          <h1 class="text-left"><spring:message code="home.news" /></h1>
          <c:forEach items="${content}" var="news">
          <div class="newsRow">
            <div class="news-lt">
              <div class="mm-video"> <img src="<%=request.getContextPath()%>${news.newsImage}" alt="">
<%--               	<video width="100%" controls>
				  <source src="<%=request.getContextPath()%>${news.newsVideo}" type="video/mp4">
				</video> --%>
              </div>
            </div>
            <div class="news-rt">
