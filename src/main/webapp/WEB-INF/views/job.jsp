...
<title><spring:message code="footer.jobs" /></title>
  ...
  <section class="container">
    <div class="inner-row">
      <div class="form-tutor-con">
        <div class="bcm-tutor-con news-con">
          <h1 class="text-left"><spring:message code="footer.jobs" /></h1>
          <c:forEach items="${content}" var="job">
          <div class="newsRow">
            <div class="news-lt">
              <div class="mm-video">  <img src="<%=request.getContextPath()%>${job.jobImage}" alt="">
<%--               	<video width="100%" controls>
				  <source src="<%=request.getContextPath()%>${job.jobVideo}" type="video/mp4">
				</video> --%>
              </div>
            </div>
            <div class="news-rt">
