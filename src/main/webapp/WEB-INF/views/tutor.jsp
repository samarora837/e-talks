    ...
    <div class="inner-row">
      <div class="form-tutor-con">
        <div class="bcm-tutor-con privacy-con">
          <h1 class="text-left"><spring:message code="tutor.becomeatutor" /></h1>
          <div class="abt-lt">
  ${content}
          </div>
          <div class="abt-rt">
            <div class="mm-video"><%--  <img src="<%=request.getContextPath()%>/images/classroom-video-img.jpg" alt=""> --%>
                    <div class="video">
...
<!--               <div id="mmVideoBtnRow">
            ...
            <div class="bcm-a-tutor"> <a href="<%=fbConnection.getFBAuthUrl()%>"><spring:message code="signup.registerfacebook"></spring:message></a> </div>
          </div>
        </div>
      </div>
    </div>
