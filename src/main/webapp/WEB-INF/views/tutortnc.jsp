...
<title><spring:message code="footer.termsandcondition" /></title>
  ...
  <section class="container">
    <div class="inner-row">
      <div class="form-tutor-con">
        <div class="bcm-tutor-con faq-con">
            	<h1 class="text-left"><spring:message code="footer.termsandcondition" /></h1>
${content}
