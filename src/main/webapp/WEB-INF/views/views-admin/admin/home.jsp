...
<body onload="navigationUpdate();" class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo page-container-bg-solid">
<!-- BEGIN HEADER -->
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/admin/home"><spring:message code="dashboard"/></a>
					</li>
				</ul>
			</div>
			<h3 class="page-title">
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat grey-mint">
						...
						<a class="more" href="<%=request.getContextPath()%>/admin/activeChatReports">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<a class="more" href="<%=request.getContextPath()%>/admin/messageReports">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
			...
			<!-- END DASHBOARD STATS -->
					...
					<div class="dashboard-stat purple-plum">
						...
						<a class="more" href="<%=request.getContextPath()%>/admin/unAcceptedSessions">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-pink">
						...
						<a class="more" href="<%=request.getContextPath()%>/admin/acceptedSessions">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat yellow-saffron">
						...
						<a class="more" href="<%=request.getContextPath()%>/admin/cancelledSessions">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-jungle">
						...
						<a class="more" href="<%=request.getContextPath()%>/admin/loginLogoutReports">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-soft">
						...
						<a class="more" href="<%=request.getContextPath()%>/admin/supportLoginLogoutReports">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
