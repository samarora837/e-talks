		...
		<div class="page-content">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn default" data-dismiss="modal"><spring:message code="admin.close"/></button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/admin/profile"><spring:message code="my.profile"/></a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
