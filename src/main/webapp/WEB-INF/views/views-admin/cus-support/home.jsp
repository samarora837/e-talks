...
<title>MiProfe | <spring:message code="customer.support"/></title>
...
<body onload="navigationUpdate(); getIp();" class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo page-container-bg-solid">
<!-- BEGIN HEADER -->
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/cus-care/home"><spring:message code="dashboard"/></a>
					</li>
				</ul>
			...
			<!-- BEGIN DASHBOARD STATS -->
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-jungle">
						...
						<div class="details">
							<div class="number" id="chatSupport">
								 0
							</div>
							<div class="desc">
								 <spring:message code="chatsupport.touser"/>
							</div>
						</div>
						<a class="more" href="<%=request.getContextPath()%>/cus-care/activeChatReports">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-soft">
						...
						<div class="details">
							<div class="number" id="messageSupport">
								 0
							</div>
							<div class="desc">
								<spring:message code="messagesupport.toUser"/>
							</div>
						</div>
						<a class="more" href="<%=request.getContextPath()%>/cus-care/supportLoginLogoutReports">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<a class="more" href="<%=request.getContextPath()%>/cus-care/messageReports">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
			...
			<!-- END DASHBOARD STATS -->
					...
					<div class="dashboard-stat purple-plum">
						...
						<a class="more" href="<%=request.getContextPath()%>/cus-care/unAcceptedSessions">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-pink">
						...
						<a class="more" href="<%=request.getContextPath()%>/cus-care/acceptedSessions">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat yellow-saffron">
						...
						<a class="more" href="<%=request.getContextPath()%>/cus-care/cancelledSessions">
						<spring:message code="view.all"/> <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
...
<script type="text/javascript">
    ...
    function DisplayIP(response) {
    	...
    	var url='<%=request.getContextPath()%>/cus-care/saveUserIP';
    	$.ajax({
    		url:url,
    		method:'GET',
    		async :false,
			...
			$.ajax({
				...
				success:function(response){
					if(response != null){
						...
						if(response.modelMap.chatToSupport>'0'){
							//$("#activeMessage").show();
							$("#chatSupport").text(response.modelMap.chatToSupport);
						}
						if(response.modelMap.messagetosuport>'0'){
							//$("#activeMessage").show();
							$("#messageSupport").text(response.modelMap.messagetosuport);
						}
					}
				}
			});  
