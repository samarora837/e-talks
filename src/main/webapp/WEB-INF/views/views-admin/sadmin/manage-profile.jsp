...
<title><spring:message code="customer.profile"/> </title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<spring:message code="my.profile"/> <small><spring:message code="user.accountsettings"/></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/sys-admin/profile"><spring:message code="my.profile"/> </a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
					...
					<div class="profile-sidebar">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								<img src="<%=request.getContextPath()%>/profilePictures/${dtoSuperAdminDetails.userId}/fileupload/${dtoSuperAdminDetails.userId}${dtoSuperAdminDetails.imageName}" class="img-responsive" alt="">
							</div>
							<!-- END SIDEBAR USERPIC -->
							<!-- SIDEBAR USER TITLE -->
							<div class="profile-usertitle">
								...
								<div class="profile-usertitle-job">
									<spring:message code="super.admin"/> 
								</div>
							</div>
								...
								<div class="portlet light">
									<div class="portlet-title tabbable-line">
										...
										<ul class="nav nav-tabs">
											...
											<li>
												<a href="#tab_1_2" data-toggle="tab"><spring:message code="change.profileImage"/></a>
											</li>
											<li>
												<a href="#tab_1_3" data-toggle="tab"><spring:message code="change.password"/></a>
											</li>
										</ul>
									</div>
									...
									<div class="portlet-body">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab_1_1">
												...
												<div class="form-body">
													<div class="form-group">
														...
														<form:input path="fname" id="fname" name="fname" type="text" value="${dtoSuperAdminDetails.fname}" placeholder="${fname}" class="form-control"/>
													</div>
													<div class="form-group">
														<label class="control-label"><spring:message code="student.lastname"/></label>
														<form:input path="lname" id="lname" name="lname" type="text" value="${dtoSuperAdminDetails.lname}" placeholder="${lname}" class="form-control"/>
													</div>
													<div class="form-group">
														<label class="control-label"><spring:message code="mobilenumber"/></label>
														<form:input path="mobileNumber" id="mobileNumber" name="mobileNumber" type="text" value="${dtoSuperAdminDetails.mobileNumber}" placeholder="${mnumber}" class="form-control" maxlength="12"/>
													</div>
											...
											<div class="tab-pane" id="tab_1_2">
												...
												<form:form name="superAdminEditForm" id="superAdminEditForm" method="post" commandName="dtoTutorDetails" action="updateImage" enctype="multipart/form-data" role="form">
													...
													<div class="margin-top-10">
														<button type="submit" class="btn blue"><spring:message code="parent.submit"/></button>
											...
											<div class="tab-pane" id="tab_1_3">
												...
												<div class="form-body">
													<div class="form-group">
														<label class="control-label"><spring:message code="current.password"/></label>
													...
													<div class="form-group">
														<label class="control-label"><spring:message code="signup.confirmpassword"/></label>
