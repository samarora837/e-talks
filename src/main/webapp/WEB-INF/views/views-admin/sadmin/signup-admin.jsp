...
<title>MiProfe | <spring:message code="admin.signup"/></title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<spring:message code="admin"/> <small><spring:message code="registeration.form"/></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/sys-admin/manage-admin"><spring:message code="admin"/></a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=request.getContextPath()%>/sys-admin/signup-admin"><spring:message code="create.newadmin"/></a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
						...
						<div class="tab-pane active" id="tab_0">
								<div class="portlet box red">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><spring:message code="create.newadmin"/>
										</div>
										<!-- <div class="tools">
							...
							<!-- BEGIN FORM-->
							<form:form action="save-admin" method="POST" id="form_sample_1" class="form-horizontal" commandName="dtoTutorDetails">
								<div class="form-body">
									...
									<div class="alert alert-success display-hide">
										<button class="close" data-close="alert"></button>
										<spring:message code="admin.createdsuccussfully"/>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<a  class="btn default" href="<%=request.getContextPath()%>/sys-admin/manage-admin">
...
function navigationUpdate(){
	$("#adminMenu").addClass("start active open");
	$("#adminSelect").addClass("selected");
	$("#adminOpen").addClass("arrow open");
