...
<title>MiProfe | <spring:message code="manage.admin"/></title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<spring:message code="admin"/> <small><spring:message code="manage.alladmins"/></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/sys-admin/manage-admin"><spring:message code="manage.admin"/></a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i><spring:message code="manage.alladmins"/>
							</div>
							<!-- <div class="tools">
...
<!-- responsive -->
							...
							<form:form  id="form_sample_1" commandName="dtoTutorDetails" method="post" action="updateAdminDetails">
							<div class="form-body">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
									<h4 class="modal-title"><spring:message code="update.adminprofiledetails"/> </h4>
								</div>
