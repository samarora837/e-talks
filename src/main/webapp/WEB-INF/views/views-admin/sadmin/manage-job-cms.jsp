...
<title><spring:message code="manage.job"/> </title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<spring:message code="manage.job"/>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/sys-admin/manageJob"><spring:message code="manage.job"/> </a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><spring:message code="manage.job"/>
							</div>
						</div>
					...
					<div class="portlet box ">
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
								<a onclick="editJob('${job.job_Id}');">
									<spring:message code="edit"/> </a>&nbsp;
									<a onclick="deleteJobAlert('${job.job_Id}');">
					...
					<!-- END EXAMPLE TABLE PORTLET-->
							<!-- BEGIN FORM-->
							<form action="${request.pagecontext.contextpath}updateJob" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="jobForm">
								<div class="form-body">
									<div class="form-group last">
										<h1 class="text-left col-md-12" id="jobTitle"><spring:message code="job.one"/></h1>
...
<!-- responsive -->
							...
							<form:form name="addJob" id="form_sample_1" commandName="dtoJob" method="post" action="saveNewJob">
							<div class="form-body">
								<div class="modal-header">
									<button type="button" class="close clearFormFields" data-dismiss="modal" aria-hidden="true"></button>
									<h4 class="modal-title"><spring:message code="add.new.job"/> </h4>
								</div>
								...
								<div class="modal-body">
									<div class="row">
										...
										<h4><spring:message code="job.title"/> </h4>
											<p>
												<form:input path="jobText" id="jobText" name="jobText" class="form-control" type="text" maxlength="20"></form:input>
											</p>
										</div>
										</div>
									</div>
...
<!-- responsiveDelete -->
							...
							<form name="deleteJob" id="form_sample_1" method="POST" action="deleteJob">
							<div class="form-body">
								<div class="modal-header">
									<button type="button" class="close clearFormFields" data-dismiss="modal" aria-hidden="true"></button>
									<h4 class="modal-title"><spring:message code="delete.job"/> </h4>
								</div>
								<input type="hidden" id="deleteJobId" name="deleteJobId"/>
								<div class="modal-body">
									<div class="row">
										<div class="col-md-12">
										<div class="form-group">
										<h4><spring:message code="areyousure.deletejob"/> </h4>
										</div>
										</div>
									</div>
								</div>
...
function editJob(jobId){
	$('#jobForm').show();
	$("#jobId").val(jobId);
	var url='<%=request.getContextPath()%>/sys-admin/manageJob/'+jobId;
	$.ajax({
		url:url,
		method:'GET',
		async :false,
		success:function(response){
			if(response!=null){
				$("#jobTitle").text(response.modelMap.cmsTitle);
