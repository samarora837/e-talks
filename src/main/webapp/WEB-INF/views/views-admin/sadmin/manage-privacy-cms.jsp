...
<title><spring:message code="manage.privacy" /> </title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<spring:message code="manage.privacy"/>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/sys-admin/manageCms/privacy"><spring:message code="manage.privacy"/> </a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><spring:message code="manage.privacy" />
						</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="${request.pagecontext.contextpath}updateCms/privacy" class="form-horizontal form-bordered" method="post">
								<div class="form-body">
									<div class="form-group last">
										<h1 class="text-left col-md-12"><spring:message code="footer.privacy" /></h1>
										<div class="col-md-12">
