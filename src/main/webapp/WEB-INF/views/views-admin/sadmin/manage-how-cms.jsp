...
<title><spring:message code="manage.HowWorks" /> </title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<spring:message code="manage.HowWorks"/>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/sys-admin/manageCms/howitworks"><spring:message code="manage.HowWorks"/> </a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><spring:message code="manage.HowWorks" />
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="${request.pagecontext.contextpath}updateCms/howitworks" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post">
								<div class="form-body">
									<div class="form-group last">
										<h1 class="text-left col-md-12"><spring:message code="header.HowWorks" /></h1>
										<div class="col-md-9">
											<textarea class="ckeditor form-control" name="editor1" rows="6">${cmsContent}</textarea>
...
FormValidation.init();
CKEDITOR.config.contentsCss = '<%=request.getContextPath()%>/css/style.css' ;
user_pref("capability.policy.policynames", "allowclipboard");
user_pref("capability.policy.allowclipboard.sites", "http://10.8.11.210:8081/miprofe");
